document.addEventListener('DOMContentLoaded', () => {
    ...
    function control(e) {
        ...
        if(e.keyCode === 39) {
            direction = 1 //right arrow, move right one
        } else if (e.keyCode === 38) {
            direction = -width //up arrow, back ten squares, or directly up
        } else if (e.keyCode === 37) {
            direction = -1 //left arrow, move left one
        } else if (e.keyCode === 40) {
            direction = +width //down arrow, forward ten squares, or directly down
        }
    }
